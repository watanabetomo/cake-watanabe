...
<body>
    <div id="wrapper">
        ...
        <div id="main">
            ...
            <div id="cheesecake">
                <h1><a href="http://casamingo.gift/index_kese.htm"><?=$productCategories[$i]['name']?></a></h1>
            ...
            <?php for($j=0; $j<count($products); $j++):?>
                    <div class="contents02_<?=$j + 1?>">
                        <h2><a href="http://casamingo.gift/index_syusu2.htm"><img src="img/<?=$products[$j]['img']?>"></a></h2>
            ...
            <div id="chocolatecake">
                <h1><a href="http://casamingo.gift/index_choko.htm">chocolate cake</a></h1>
                <div class="contents03">
                    <div class="contents03_1">
                        <h2><a href="http://casamingo.gift/index_sacher.htm"><img src="img/cake05.gif"></a></h2>
                        <p><strong>ウィーンの銘菓ザッハートルテ<br></strong><br></p>
                        <p><span>通常1～4日以内に発送。</span></p>
                        <ul class="accordion">
                            <li>
                                <p>ご注文</p>
                                <ul>
                                    <li>
                                        <form method="post" action="http://cart.ec-sites.jp/cart_step2/pc/pk00/">
                                            <input name="es_item_qty" value="1" type="hidden">
                                            <input name="es_charset" value="sjis" type="hidden">
                                            <input name="es_item_id" value="6" type="hidden">
                                            <input name="es_shop_id" value="1482" type="hidden">
                                            <input name="es_stock_attr_flag" value="0" type="hidden">
                                            <input name="es_submit" value="12cm ￥3,200" type="submit">
                                        </form>
                                    </li>
                                    <li>
                                        <form method="post" action="http://cart.ec-sites.jp/cart_step2/pc/pk00/">
                                            <input name="es_item_qty" value="1" type="hidden">
                                            <input name="es_charset" value="sjis" type="hidden">
                                            <input name="es_item_id" value="7" type="hidden">
                                            <input name="es_shop_id" value="1482" type="hidden">
                                            <input name="es_stock_attr_flag" value="0" type="hidden">
                                            <input name="es_submit" value="15cm ￥3,800" type="submit">
                                        </form>
                                    </li>
                                    <li>
                                        <form method="post" action="http://cart.ec-sites.jp/cart_step2/pc/pk00/">
                                            <input name="es_item_qty" value="1" type="hidden">
                                            <input name="es_charset" value="sjis" type="hidden">
                                            <input name="es_item_id" value="253" type="hidden">
                                            <input name="es_shop_id" value="1482" type="hidden">
                                            <input name="es_stock_attr_flag" value="0" type="hidden">
                                            <input name="es_submit" value="18cm ￥4,800" type="submit">
                                        </form>
                                    </li>
                                    <li>
                                        <form method="post" action="http://cart.ec-sites.jp/cart_step2/pc/pk00/">
                                            <input name="es_item_qty" value="1" type="hidden">
                                            <input name="es_charset" value="sjis" type="hidden">
                                            <input name="es_item_id" value="8" type="hidden">
                                            <input name="es_shop_id" value="1482" type="hidden">
                                            <input name="es_stock_attr_flag" value="0" type="hidden">
                                            <input name="es_submit" value="20cm ￥6,300" type="submit">
                                        </form>
                                    </li>
                                    <li>
                                        <form method="post" action="http://cart.ec-sites.jp/cart_step2/pc/pk00/">
                                            <input name="es_item_qty" value="1" type="hidden">
                                            <input name="es_charset" value="sjis" type="hidden">
                                            <input name="es_item_id" value="9" type="hidden">
                                            <input name="es_shop_id" value="1482" type="hidden">
                                            <input name="es_stock_attr_flag" value="0" type="hidden">
                                            <input name="es_submit" value="26cm ￥8,600" type="submit">
                                        </form>
                                    </li>
                                </ul>
                            </li>
                        ...
                        <div class="qa">
                            <form action="https://cart.ec-sites.jp/cart_step2/item-question/top/shid/1482/item_id/7/" target="_blank">
                                <input value="お問い合わせ" type="submit">
                            </form>
                        </div><!--/.qa-->
                    </div><!--/.contents03_1-->
                    <div class="contents03_2">
                        <h2><a href="http://casamingo.gift/index_wald.htm"><img src="img/cake06.gif"></a></h2>
                        <p><strong>ヴァルトベーレ<br>
                                木苺チョコレートケーキ</strong><br></p>
                        <p><span>通常1～4日以内に発送。</span></p>
                        <ul class="accordion">
                            <li>
                                <p>ご注文</p>
                                <ul>
                                    <li>
                                        <form method="post" action="http://cart.ec-sites.jp/cart_step2/pc/pk00/">
                                            <input name="es_item_qty" value="1" type="hidden">
                                            <input name="es_charset" value="sjis" type="hidden">
                                            <input name="es_item_id" value="15" type="hidden">
                                            <input name="es_shop_id" value="1482" type="hidden">
                                            <input name="es_stock_attr_flag" value="0" type="hidden">
                                            <input name="es_submit" value="15cm ￥4,200" type="submit">
                                        </form>
                                    </li>
                                    <li>
                                        <form method="post" action="http://cart.ec-sites.jp/cart_step2/pc/pk00/">
                                            <input name="es_item_qty" value="1" type="hidden">
                                            <input name="es_charset" value="sjis" type="hidden">
                                            <input name="es_item_id" value="16" type="hidden">
                                            <input name="es_shop_id" value="1482" type="hidden">
                                            <input name="es_stock_attr_flag" value="0" type="hidden">
                                            <input name="es_submit" value="20cm ￥6,600" type="submit">
                                        </form>
                                    </li>
                                    <li>
                                        <form method="post" action="http://cart.ec-sites.jp/cart_step2/pc/pk00/">
                                            <input name="es_item_qty" value="1" type="hidden">
                                            <input name="es_charset" value="sjis" type="hidden">
                                            <input name="es_item_id" value="17" type="hidden">
                                            <input name="es_shop_id" value="1482" type="hidden">
                                            <input name="es_stock_attr_flag" value="0" type="hidden">
                                            <input name="es_submit" value="26cm ￥8,800" type="submit">
                                        </form>
                                    </li>
                                </ul>
                            </li>
                        ...
                        <div class="qa">
                            <form action="https://cart.ec-sites.jp/cart_step2/item-question/top/shid/1482/item_id/15/" target="_blank">
                                <input value="お問い合わせ" type="submit">
                            </form>
                        </div><!--/.qa-->
                    </div><!--/.contents03_2-->
                    <div class="contents03_3">
                        <h2><a href="http://casamingo.gift/index_aru.htm"><img src="img/cake07.gif"></a></h2>
                        <p><strong>アルレムチョコレートケーキ<br></strong><br></p>
                        <p><span>完売しました。</span></p>
                        <ul class="accordion">
                            <li>
                                <p>ご注文</p>
                                <ul>
                                    <li>
                                        <form method="post" action="http://cart.ec-sites.jp/cart_step2/pc/pk00/">
                                            <input name="es_item_qty" value="1" type="hidden">
                                            <input name="es_charset" value="sjis" type="hidden">
                                            <input name="es_item_id" value="18" type="hidden">
                                            <input name="es_shop_id" value="1482" type="hidden">
                                            <input name="es_stock_attr_flag" value="0" type="hidden">
                                            <input name="es_submit" value="15cm ￥4,200" type="submit">
                                        </form>
                                    ...
                                    <li>
                                        <form method="post" action="http://cart.ec-sites.jp/cart_step2/pc/pk00/">
                                            <input name="es_item_qty" value="1" type="hidden">
                                            <input name="es_charset" value="sjis" type="hidden">
                                            <input name="es_item_id" value="19" type="hidden">
                                            <input name="es_shop_id" value="1482" type="hidden">
                                            <input name="es_stock_attr_flag" value="0" type="hidden">
                                            <input name="es_submit" value="20cm ￥7,200" type="submit">
                                        </form>
                                    </li>
                                    <li>
                                        <form method="post" action="http://cart.ec-sites.jp/cart_step2/pc/pk00/">
                                            <input name="es_item_qty" value="1" type="hidden">
                                            <input name="es_charset" value="sjis" type="hidden">
                                            <input name="es_item_id" value="20" type="hidden">
                                            <input name="es_shop_id" value="1482" type="hidden">
                                            <input name="es_stock_attr_flag" value="0" type="hidden">
                                            <input name="es_submit" value="26cm ￥9,800" type="submit">
                                        </form>
                                    </li>
                                </ul>
                            </li>
                        ...
                        <div class="qa">
                            <form action="https://cart.ec-sites.jp/cart_step2/item-question/top/shid/1482/item_id/18/" target="_blank">
                                <input value="お問い合わせ" type="submit">
                            </form>
                        </div><!--/.qa-->
                    </div><!--/.contents03_3-->
            ...
            <div id="shortcake">
                <h1><a href="http://casamingo.gift/index_sahne.htm">Shortcake&Tarte</a></h1>
                <div class="contents03">
                    <div class="contents03_1">
                        <h2><a href="http://casamingo.gift/index_beruda.htm"><img src="img/cake08.gif"></a></h2>
                        <p><strong>シュヴァルツベルダー<br>キルシュトルテ</strong><br></p>
                        <p><span>通常1～4日以内に発送。</span></p>
                        <ul class="accordion">
                            <li>
                                <p>ご注文</p>
                                <ul>
                                    <li>
                                        <form method="post" action="http://cart.ec-sites.jp/cart_step2/pc/pk00/">
                                            <input name="es_item_qty" value="1" type="hidden">
                                            <input name="es_charset" value="sjis" type="hidden">
                                            <input name="es_item_id" value="10" type="hidden">
                                            <input name="es_shop_id" value="1482" type="hidden">
                                            <input name="es_stock_attr_flag" value="0" type="hidden">
                                            <input name="es_submit" value="15cm ￥3,800" type="submit">
                                        </form>
                                    ...
                                    <li>
                                        <form method="post" action="http://cart.ec-sites.jp/cart_step2/pc/pk00/">
                                            <input name="es_item_qty" value="1" type="hidden">
                                            <input name="es_charset" value="sjis" type="hidden">
                                            <input name="es_item_id" value="254" type="hidden">
                                            <input name="es_shop_id" value="1482" type="hidden">
                                            <input name="es_stock_attr_flag" value="0" type="hidden">
                                            <input name="es_submit" value="18cm ￥4,800" type="submit">
                                        </form>
                                    ...
                                    <li>
                                        <form method="post" action="http://cart.ec-sites.jp/cart_step2/pc/pk00/">
                                            <input name="es_item_qty" value="1" type="hidden">
                                            <input name="es_charset" value="sjis" type="hidden">
                                            <input name="es_item_id" value="11" type="hidden">
                                            <input name="es_shop_id" value="1482" type="hidden">
                                            <input name="es_stock_attr_flag" value="0" type="hidden">
                                            <input name="es_submit" value="20cm ￥6,300" type="submit">
                                        </form>
                                    ...
                                    <li>
                                        <form method="post" action="http://cart.ec-sites.jp/cart_step2/pc/pk00/">
                                            <input name="es_item_qty" value="1" type="hidden">
                                            <input name="es_charset" value="sjis" type="hidden">
                                            <input name="es_item_id" value="12" type="hidden">
                                            <input name="es_shop_id" value="1482" type="hidden">
                                            <input name="es_stock_attr_flag" value="0" type="hidden">
                                            <input name="es_submit" value="26cm ￥8,600" type="submit">
                                        </form>
                        ...
                        <div class="qa">
                            <form action="https://cart.ec-sites.jp/cart_step2/item-question/top/shid/1482/item_id/10/" target="_blank">
                                <input value="お問い合わせ" type="submit">
                            </form>
                        </div><!--/.qa-->
                    </div><!--/.contents03_1-->
                    <div class="contents03_2">
                        <h2><a href="http://casamingo.gift/index_f.htm"><img src="img/cake09.gif"></a></h2>
                        <p><strong>フロッケンザーネトルテ<br></strong><br></p>
                        <p><span>通常1～4日以内に発送。</span></p>
                        <ul class="accordion">
                            <li>
                                <p>ご注文</p>
                                <ul>
                                    <li>
                                        <form method="post" action="http://cart.ec-sites.jp/cart_step2/pc/pk00/">
                                            <input name="es_item_qty" value="1" type="hidden">
                                            <input name="es_charset" value="sjis" type="hidden">
                                            <input name="es_item_id" value="21" type="hidden">
                                            <input name="es_shop_id" value="1482" type="hidden">
                                            <input name="es_stock_attr_flag" value="0" type="hidden">
                                            <input name="es_submit" value="15cm ￥4,000" type="submit">
                                        </form>
                                    </li>
                                    <li>
                                        <form method="post" action="http://cart.ec-sites.jp/cart_step2/pc/pk00/">
                                            <input name="es_item_qty" value="1" type="hidden">
                                            <input name="es_charset" value="sjis" type="hidden">
                                            <input name="es_item_id" value="22" type="hidden">
                                            <input name="es_shop_id" value="1482" type="hidden">
                                            <input name="es_stock_attr_flag" value="0" type="hidden">
                                            <input name="es_submit" value="20cm ￥6,300" type="submit">
                                        </form>
                                    ...
                                    <li>
                                        <form method="post" action="http://cart.ec-sites.jp/cart_step2/pc/pk00/">
                                            <input name="es_item_qty" value="1" type="hidden">
                                            <input name="es_charset" value="sjis" type="hidden">
                                            <input name="es_item_id" value="23" type="hidden">
                                            <input name="es_shop_id" value="1482" type="hidden">
                                            <input name="es_stock_attr_flag" value="0" type="hidden">
                                            <input name="es_submit" value="26cm ￥9,800" type="submit">
                                        </form>
                        ...
                        <div class="qa">
                            <form action="https://cart.ec-sites.jp/cart_step2/item-question/top/shid/1482/item_id/21/" target="_blank">
                                <input value="お問い合わせ" type="submit">
                            </form>
                        </div><!--/.qa-->
                    </div><!--/.contents03_2-->
                    <div class="contents03_3">
                        <h2><a href="http://casamingo.gift/index_enga.htm"><img src="img/cake10.gif"></a></h2>
                        <p><strong>エンガディナー　ヌストルテ<br></strong><br></p>
                        <p><span>通常1～4日以内に発送。</span></p>
                        <ul class="accordion">
                            <li>
                                <p>ご注文</p>
                                <ul>
                                    <li>
                                        <form method="post" action="http://cart.ec-sites.jp/cart_step2/pc/pk00/">
                                            <input name="es_item_qty" value="1" type="hidden">
                                            <input name="es_charset" value="sjis" type="hidden">
                                            <input name="es_item_id" value="24" type="hidden">
                                            <input name="es_shop_id" value="1482" type="hidden">
                                            <input name="es_stock_attr_flag" value="0" type="hidden">
                                            <input name="es_submit" value="16cm ￥3,650" type="submit">
                                        </form>
                                    </li>
                                    <li>
                                        <form method="post" action="http://cart.ec-sites.jp/cart_step2/pc/pk00/">
                                            <input name="es_item_qty" value="1" type="hidden">
                                            <input name="es_charset" value="sjis" type="hidden">
                                            <input name="es_item_id" value="25" type="hidden">
                                            <input name="es_shop_id" value="1482" type="hidden">
                                            <input name="es_stock_attr_flag" value="0" type="hidden">
                                            <input name="es_submit" value="18cm ￥4,800" type="submit">
                                        </form>
                                    ...
                                    <li>
                                        <form method="post" action="http://cart.ec-sites.jp/cart_step2/pc/pk00/">
                                            <input name="es_item_qty" value="1" type="hidden">
                                            <input name="es_charset" value="sjis" type="hidden">
                                            <input name="es_item_id" value="26" type="hidden">
                                            <input name="es_shop_id" value="1482" type="hidden">
                                            <input name="es_stock_attr_flag" value="0" type="hidden">
                                            <input name="es_submit" value="25cm ￥8,400" type="submit">
                                        </form>
                                    </li>
                                </ul>
                            </li>
                        ...
                        <div class="qa">
                            <form action="https://cart.ec-sites.jp/cart_step2/item-question/top/shid/1482/item_id/24/" target="_blank">
                                <input value="お問い合わせ" type="submit">
                            </form>
                        </div><!--/.qa-->
                    </div><!--/.contents03_3-->
            ...
            <div id="seasoncake">
                <h1><a href="#seasoncake">Season cake</a></h1>
                <div id="contents04">
                    <div class="contents02">
                        <div class="contents02_1">
                            <h2><a href="#open04"><img src="img/cake11.gif"></a></h2>
                            <p><strong>タルト・オー・シトロン<br>レモンのタルト</strong><br>
                                <p><span>通常1～4日以内に発送。</span></p>
                            <ul class="accordion">
                                <li>
                                    ...
                                    <ul>
                                        <li>
                                            <form method="post" action="http://cart.ec-sites.jp/cart_step2/pc/pk00/">
                                                <input name="es_item_qty" value="1" type="hidden">
                                                <input name="es_charset" value="sjis" type="hidden">
                                                <input name="es_item_id" value="88" type="hidden">
                                                <input name="es_shop_id" value="1482" type="hidden">
                                                <input name="es_stock_attr_flag" value="0" type="hidden">
                                                <input name="es_submit" value="16cm ￥3,650" type="submit">
                                            </form>
                                        ...
                                        <li>
                                            <form method="post" action="http://cart.ec-sites.jp/cart_step2/pc/pk00/">
                                                <input name="es_item_qty" value="1" type="hidden">
                                                <input name="es_charset" value="sjis" type="hidden">
                                                <input name="es_item_id" value="89" type="hidden">
                                                <input name="es_shop_id" value="1482" type="hidden">
                                                <input name="es_stock_attr_flag" value="0" type="hidden">
                                                <input name="es_submit" value="18cm ￥4,800" type="submit">
                                            </form>
                            ...
                            <div class="qa">
                                <form action="https://cart.ec-sites.jp/cart_step2/item-question/top/shid/1482/item_id/88/" target="_blank">
                                    <input value="お問い合わせ" type="submit">
                                </form>
                            </div><!--/.qa-->
                        </div><!--/.contents02_1-->
                        <div class="contents02_2">
                            <h2><a href="#open05"><img src="img/cake12.gif"></a></h2>
                            <p><strong>ムース・オー・カシス<br></strong><br>
                                <p><span>完売しました。</span></p>
                            <ul class="accordion">
                                <li>
                                    <p>ご注文</p>
                                    <ul>
                                        <li>
                                            <form method="post" action="http://cart.ec-sites.jp/cart_step2/pc/pk00/">
                                                <input name="es_item_qty" value="1" type="hidden">
                                                <input name="es_charset" value="sjis" type="hidden">
                                                <input name="es_item_id" value="69" type="hidden">
                                                <input name="es_shop_id" value="1482" type="hidden">
                                                <input name="es_stock_attr_flag" value="0" type="hidden">
                                                <input name="es_submit" value="15cm ￥4,000" type="submit">
                                            </form>
                                        ...
                                        <li>
                                            <form method="post" action="http://cart.ec-sites.jp/cart_step2/pc/pk00/">
                                                <input name="es_item_qty" value="1" type="hidden">
                                                <input name="es_charset" value="sjis" type="hidden">
                                                <input name="es_item_id" value="70" type="hidden">
                                                <input name="es_shop_id" value="1482" type="hidden">
                                                <input name="es_stock_attr_flag" value="0" type="hidden">
                                                <input name="es_submit" value="20cm ￥6,300" type="submit">
                                            </form>
                            ...
                            <div class="qa">
                                <form action="https://cart.ec-sites.jp/cart_step2/item-question/top/shid/1482/item_id/69/" target="_blank">
                                    <input value="お問い合わせ" type="submit">
                                </form>
                            </div><!--/.qa-->
                        </div><!--/.contents02_2-->
