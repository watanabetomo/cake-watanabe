...
class CartModel extends Model
{
    ...
    public function purchaseComplete()
    {
        ...
        try {
            ...
            if (!mb_send_mail($_SESSION['purchase_info']['mail'], '【洋菓子店カサミンゴー】ご購入商品確認メール', $mailBody, 'From:' . mb_encode_mimeheader('洋菓子店カサミンゴー'))) {
                throw new Exception;
            }
            $this->dbh->commit();
        } catch (Exception $e) {
